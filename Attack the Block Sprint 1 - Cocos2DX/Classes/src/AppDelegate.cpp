...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	// Need to add "data" path too.
	searchPath.push_back("OptionsScene");
	...
	LevelLoader loader("OptionsScene/GameData.json");

	CocosDenshion::SimpleAudioEngine::sharedEngine()->preloadBackgroundMusic("Audio/background.mp3");
